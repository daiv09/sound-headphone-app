                        ...
                        <ul className="space-y-3 text-xs text-zinc-300">
                           ...
                           <li className="flex items-start gap-2">
                              ...
                              <div>
                                 ...
                                 <p className="text-[11px] text-zinc-400 leading-relaxed">
                                    {isLeft
                                       ? 'Left channel focuses on road noise and low‑frequency rumble, shaping the filter around engines and transit so your mix stays clean in motion.'
                                       : 'Right channel prioritizes human chatter and high‑frequency detail, softening sharp consonants and clatter without dulling vocals or game cues.'}
                                 </p>
                              </div>
                           </li>
                           ...
                           <li className="flex items-start gap-2">
                              ...
                              <div>
                                 ...
                                 <p className="text-[11px] text-zinc-400 leading-relaxed">
                                    {isLeft
                                       ? 'The left mic cluster tracks jaw motion and bone‑conducted cues to keep your voice center‑framed, even when you turn away from the phone.'
                                       : 'The right mic cluster steers a narrow beam toward your mouth and aggressively nulls keyboard and mouse noise for sharper comms.'}
                                 </p>
                              </div>
                           </li>
                           ...
                           <li className="flex items-start gap-2">
                              ...
                              <div>
                                 ...
                                 <p className="text-[11px] text-zinc-400 leading-relaxed">
                                    {isLeft
                                       ? 'Left earbud anchors timing and clock sync, keeping spatial cues and bass transients under 30 ms glass‑to‑ear for competitive play.'
                                       : 'Right earbud adapts bitrate on the fly, prioritizing positional detail and clarity so footsteps and reloads stay precisely locatable.'}
                                 </p>
                              </div>
                           </li>
                        </ul>
