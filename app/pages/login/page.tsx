                    ...
                    <div className="hidden md:flex flex-col justify-between border-r border-zinc-800/70 p-8 lg:p-10">
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-sm text-zinc-300 leading-relaxed">
                                Create an account to sync presets, personalize ANC, and keep your
                                SOUND Pro X updated—across every device you use.
                            </p>
                            ...
                            >
                                {mode === 'signup' ? (
                                    ...
                                    >
                                        ...
                                        {/* Keep your signup code exactly as you have it now */}
                                    </motion.div>
                                ) : (
                                    <motion.div
                                        key="login"
